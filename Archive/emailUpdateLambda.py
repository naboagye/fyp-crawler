...
def sendEmail(email, destination, dailyCases, rate, date):
...
<body style="margin:0;padding:0;word-spacing:normal;background-color:#E6F1F5;">
  <div role="article" aria-roledescription="email" lang="en" style="text-size-adjust:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#E6F1F5;">
          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:30px;background-color:#ffffff;">
                ...
                <p style="margin:0;">Number of cases in the last 24 hours: $dailyCases</p>
                <p style="margin:0;">Weekly Rate per 100,000 people: $rate</p>
              </td>
            </tr>
            <tr>
    ...
    html = html_template.substitute(date=date, dailyCases=dailyCases, rate=rate, destination=destination)
    BODY_HTML = html        
...
def lambda_handler(event, context):
    ...
    for item in scan_table(dynamodb, TableName="Subscriptions"):
        ...
        sendEmail(email, code, cases, rate, today)
